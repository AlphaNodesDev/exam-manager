                            ...
                            <div class="col-sm-8">
                                ...
                                <table class="table table-bordered table-condensed table-hover table-striped">
                                    ...
                                    <tr>
                                        <td><?php echo $i ?></td>
                                        <td><?php echo $re[1] ?></td>
                                        <td><a href="exam.php?eid=<?php echo $re[0] ?>"><span
                                                    class="fa fa-arrow-circle-right" style="color: green"
                                                    title="Find My Seats"></span></a></td>
                                    </tr>
                                    <?php                                                                
                                                            }
                                                            ?>
...
$current_time = $current_time->format('H:i:s'); echo $current_time;


																		if($rxam[8] <= $current_time){
                                                                        $selrm=mysqli_query($dbcon,"select * from room_assign where eid='$eid' and rolnum='$uid' and dt='$rxam[7]' and tim='$rxam[8]'");
