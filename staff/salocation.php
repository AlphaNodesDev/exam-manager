                ...
                <ul class="nav ace-nav">
                    ...
                    <li class="light-blue">
                        <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                            <img class="nav-user-photo" src="../admin/staff_pic/<?php echo $rdata[10] ?>"
                                alt="Administrator" />
                            ...
                            <div class="col-lg-8">
                                ...
                                <table class="table table-bordered table-condensed table-hover table-striped">
                                    ...
                                    <tr>
                                        <td><?php echo $i ?></td>
                                        <td><?php echo $re[1] ?></td>
                                        <td><a href="salocation.php?eid=<?php echo $re[0] ?>"><span
                                                    class="fa fa-arrow-circle-right" style="color: green"
                                                    title="ASSIGN EXAMINATION"></span></a></td>
                                    </tr>
                                    <?php                                                                
                                                            }
                                                            ?>
                        ...
                        <div class="col-xs-12">
                            <form method="post">
                                ...
                                <div class="alert alert-success">
                                    <center>
                                        Student List are Sorted Successfully!!, Please Click PROCEED button to
                                        Continue...
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                                                   ...
                                                                   {
                                                                       ?>
                                            <span class="fa fa-file-text" title="View Allocated Details"
                                                style="cursor: pointer; color: green;" data-toggle="modal"
                                                data-target="#myModal<?php echo $i ?>"></span>
                                            |
                                            <a target="_BLANK"
                                                href="print.php?eid=<?php echo $_GET['eid'] ?>&dt=<?php echo $rdt[0] ?>&ti=<?php echo $rtime[0] ?>"
                                                class="fa fa-print"></a>
                                            <a
                                                href="salocation.php?eid=<?php echo $_GET['eid'] ?>&deldt=<?php echo $rdt[0] ?>&ti=<?php echo $rtime[0] ?>"><span
                                                    class="fa fa-trash" style="color: red; float: right;"></span></a>
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            ...
                                                            <h4 class="modal-title">
                                                                <b><?php echo date("d-M-Y",strtotime($rdt[0])) ?>
                                                                    (<?php echo $rtime[0] ?>)</b></h4>
                                                        </div>
                                                        <div class="modal-body" style="overflow-y: scroll;">
                                                            ...
                                                            <table
                                                                ...
                                                                <tr>
                                                                    <td style="width: 5%"></td>
                                                                    <td colspan="2" style="color: #cc0000">Room :
                                                                        <b><?php echo $rrm[0] ?></b>
                                            ...
                                            <?php
                                                                   ...
                                                                   ?>
                                            <a
                                                href="salocation.php?eid=<?php echo $eid ?>&dt=<?php echo $rdt[0] ?>&ti=<?php echo $rtime[0] ?>"><span
                                                    class="fa fa-arrow-circle-o-right" title="Assign Chair"
...
<![endif]-->
    ...
    if ('ontouchstart' in document.documentElement) document.write(
        "<script src='../admin_tmplate/assets/js/jquery.mobile.custom.js'>" + "<" + "/script>");
    </script>
