                        ...
                        <div class="col-xs-12">
                            <div class="col-md-6">
                                <form method="post">
                                    ...
                                    <table class="table table-bordered table-condensed table-hover table-striped">
                                        ...
                                        <tr>
                                            <td>Block Name</td>
                                            <td><input type="text" name="bn1" value="<?php echo $r1[1] ?>"
                                                    class="form-control" /></td>
                                        </tr>
                                        <tr>
                                            <td>Room Number</td>
                                            <td><input type="text" name="rn1" value="<?php echo $r1[2] ?>"
                                                    class="form-control" /></td>
                                        </tr>
                                        <tr>
                                            <td>Bench Available</td>
                                            <td><input type="text" name="ba1" value="<?php echo $r1[3] ?>"
                                                    class="form-control" /></td>
                                        </tr>
                                        <tr>
                                            <td>No of Rows</td>
                                            <td><input type="text" name="nr1" class="form-control"
                                                    value="<?php echo $r1[4] ?>" /></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
                                                <center>
                                                    <input type="submit" name="sub1" value="EDIT ROOM DETAILS"
                                    ...
                                    <table class="table table-bordered table-condensed table-hover table-striped">
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <center>
                                                    <input type="submit" name="sub" value="ADD ROOM"
                                                        class="btn btn-sm btn-primary" />
                                                </center>
                                            </td>
                                        </tr>
                            ...
                            <div class="col-md-6">
                                ...
                                <table class="table table-bordered table-condensed table-hover table-striped">
                                    <tr>
                                        <td colspan="6">
                                            <center><b>AVAILABLE ROOM DETAILS</b></center>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>#</td>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $rr[4] ?></td>
                                        <td>
                                            <a href="room.php?did=<?php echo $rr[0] ?>"><span class="fa fa-trash"
                                                    style="color: red;"></span></a> |
                                            <a href="room.php?edit=<?php echo $rr[0] ?>"><span class="fa fa-edit"
