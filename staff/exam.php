                        ...
                        <div class="col-md-6">
                            ...
                            <form method="post">
                                <table class="table table-bordered table-condensed table-hover table-striped">
                                    <tr>
                                        <td colspan="2">
                                            <center><b>ASSIGN EXAM HERE</b></center>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Programme</td>
                            ...
                            <form method="post">
                                <table class="table table-bordered table-condensed table-hover table-striped">
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <center>
                                                <input type="submit" name="sub" value="ADD EXAM"
                        ...
                        <div class="col-md-6">
                            ...
                            <table class="table table-bordered table-condensed table-hover table-striped">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $re[1] ?></td>
                                    <td>
                                        <a href="exam.php?eid=<?php echo $re[0] ?>"><span
                                                class="fa fa-arrow-circle-right" style="color: green"
                                                title="ASSIGN EXAMINATION"></span></a> |
                                        <a href="exam.php?did=<?php echo $re[0] ?>"><span
                                                class="fa fa-arrow-circle-down" style="color: red"
                                                title="EXAMINATION COMPLETED"></span></a>
                                    </td>
                                </tr>
                                <?php                                                                
                                                            }
